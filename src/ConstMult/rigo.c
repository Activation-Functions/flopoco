...
The steps are the following:
    ...
    Code by Rapha�l RIGO / 2003 / Licensed under the GPL
    Minor modifications by Vincent Lef�vre, 2004, 2005
  ...
  for (i = - length1 - length2 + 1; i < length1 + length2; i++)
    {
      ...
      if (verbose > 0 && ABS(i) != length1)
        printf("D�calage : %3d\tPos : %2d\tPoids : %d\tMotif : %s\n",
