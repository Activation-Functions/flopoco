...
class Operator;
	...
	public:
		...
		*/
		 ...
		 */
		std::vector<std::pair<Signal*, int>>* predecessors();
		 ...
		 */
		std::pair<Signal*, int>* predecessorPair(int count);

		/**
		 * Returns the list of successors
		 */
		std::vector<std::pair<Signal*, int>>* successors();
		 ...
		 */
		std::pair<Signal*, int>* successorPair(int count);
		 ...
		 */
		void addPredecessors(std::vector<std::pair<Signal*, int>> predecessorList);
		 ...
		 */
		void addSuccessors(std::vector<std::pair<Signal*, int>> successorList);
	...
	private:
		...
		static const std::vector<std::string> dotNodeColors;     /**< the possible colors used for the dot diagrams */
	};
