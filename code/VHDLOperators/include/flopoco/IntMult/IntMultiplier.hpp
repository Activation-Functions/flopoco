...
namespace flopoco {
	...
	public:
		 ...
		 **/
		IntMultiplier(Operator *parentOp, Target* target, int wX, int wY, int wOut=0, bool signedIO = false, float dspOccupationThreshold=0.0, int maxDSP=-1, bool superTiles=false, bool use2xk=false, bool useirregular=false, bool useLUT=true, bool useDSP=true, bool useKaratsuba=false, bool useGenLUT=false, int beamRange=0, bool optiTrunc=true, bool minStages=true, bool squarer=false);
