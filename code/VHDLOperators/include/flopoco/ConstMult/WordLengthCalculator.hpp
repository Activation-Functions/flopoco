...
namespace flopoco {
    ...
    class WordLengthCalculator {
        ...
        public:
            WordLengthCalculator(PAGSuite::adder_graph_t adder_graph, int wIn, double epsilon, Target* target= nullptr) : adder_graph_(adder_graph), wIn_(wIn), errorBudget_(epsilon), target_(target){}
