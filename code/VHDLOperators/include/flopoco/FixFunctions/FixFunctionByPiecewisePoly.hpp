...
namespace flopoco
{
  ...
  class FixFunctionByPiecewisePoly : public Operator {
    ...
    /**
		 ...
		 */
    FixFunctionByPiecewisePoly(OperatorPtr parentOp,
      Target* target,
      string func,
      int lsbIn,
      int lsbOut,
    ...
    vector<int>
      sigmaMSB; /**< vector of MSB weights for each sigma term. Note that these MSB consider that sigma is signed: one may remove 1 if sigmaSign is +1 or -1  */
  };
