...
namespace flopoco
{
  ...
  class FixFunctionByMultipartiteTable : public Operator {
    ...
    /**
		 ...
		 */
    FixFunctionByMultipartiteTable(OperatorPtr parentOp, Target* target, string function, int nbTOi, bool signedIn, int lsbIn, int lsbOut);
    ...
    vector<vector<vector<double>>>
      oneTableError;               /** for nbTOi fixed, the errors of each possible table configuration, precomputed  here to speed up exploration  */
